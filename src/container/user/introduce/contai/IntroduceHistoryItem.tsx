...
import { IIntroduceHistory } from "@/modules/interface/IIntroduceData";
import { formatMonthAndYearString } from "@/utils/format";
import { Flex, Stack, Text } from "@mantine/core";

export default function IntroduceHistoryItem() {
  const data: IIntroduceHistory = introduceData.introduceHistory || {};
              ...
              <Flex key={index}>
                ...
                >
                  <Text size="xl" fw={600} mb={5}>
                    {item.day && formatMonthAndYearString(item.day)}
                  </Text>
