...
export default function StudentsImportModal() {
  ...
  const importMutation = useMutation({
    mutationFn: (formData: FormData) => studentApi.importExcel(formData),
      ...
      <Table withColumnBorders striped mb={4}>
        <Table.Thead>
          <Table.Tr>
            ...
            <Table.Th>educationLevel</Table.Th>
            <Table.Th>educationClass</Table.Th>
            <Table.Th>educationSchool</Table.Th>
          </Table.Tr>
        </Table.Thead>
        <Table.Tbody>
          <Table.Tr>
